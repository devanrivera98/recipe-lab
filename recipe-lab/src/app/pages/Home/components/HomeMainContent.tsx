  ...
  return (
    <>
      <section className="home-top-of-page pt-16 px-2 md:px-0  mb-16">
        <div className="hosting-card cursor-pointer">
          <img alt="martha-stewart-recipe-collection" src="./images/martha-stewart-photo.jpg" />
          <div className="py-1">
            <h1 className="hosting-card-title text-3xl py-2">Discover the Best Recipes: Perfect for Hosting Every Occasion</h1>
