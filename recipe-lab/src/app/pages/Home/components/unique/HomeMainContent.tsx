...
// breaking down the food news and giving it a reusable component with a article-card mixin is next
        ...
        <div className="article-card">
          ...
          <div className="bg-fadedGreen p-6">
            ...
            {foodNewsArticles.map((article, index) => {
              return (
                <FoodNewsCard key={index} image={article.image} title={article.title} />
              )
            }) }
            </div>
          </div>
